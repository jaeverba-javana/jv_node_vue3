...
<!--            <swiper-slide tag="li">
            ...
            <swiper-slide tag="li" v-for="(item, index) in latestPosts" :key="index">
                <v-skeleton-loader
                    ...
                    min-height="100%"
                >
                  <router-link :to="`${$route.params.lang? '/'+$route.params.lang : ''}/blog/post/${item.id}`">
                    <v-card elevation="0" width="100%" height="100%" class="mx-auto miniPost" color="surface-variant">
                      ...
                      <v-card-title style="padding-bottom: 0">
                        <m-text :type="Theme.typography.titleSmall" style="margin-bottom: -5px">
                          {{ item.title }}
                        </m-text>
                      </v-card-title>
                      ...
                      <v-card-actions>
                        <m-text :type="Theme.typography.labelSmall"><span class="fecha">{{ item.date }}</span></m-text>
                      ...
                      <v-expand-transition class="v-expand-transition">
                        ...
                        >
                          <div style="display: flex; flex-direction: column; height: 100%">
                            <v-card-text class="">
                              <m-text>{{item.description}}</m-text>
                            </v-card-text>
...
export default {
    ...
    components: {MText, Swiper, SwiperSlide},
    props: {
      latestPosts: Object
    },
    setup() {
