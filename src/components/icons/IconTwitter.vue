...
<template>
  <svg
    ...
    <g>
      ...
      <use xlink:href="#mascaraT" style="overflow: visible" />


      <clipPath id="mascaraT-">
        <use xlink:href="#mascaraT" style="overflow: visible" />
      </clipPath>
