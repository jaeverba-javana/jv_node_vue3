    ...
    <form @submit.prevent="submit">
      <div class="input_nom">
        <v-text-field
            ...
            :prepend-inner-icon="icons.classic.duotone.user"
        ></v-text-field>
      ...
      <div class="input_dir">
        <v-text-field
            ...
            :prepend-inner-icon="icons.classic.duotone.envelope"
        ></v-text-field>
      ...
      <div class="input_men">
        <v-textarea
            ...
            counter="200"
            color="var(--md-sys-color-on-surface-variant)"
            :prepend-inner-icon="icons.classic.duotone.messages"
            clearable>
        </v-textarea>
      ...
      <div class="boton">
        <v-btn
            ...
            type="submit"
            variant="tonal"
            :prepend-icon="animationData.active? '' : icons.classic.duotone.paperPlane"
            rounded="0"
            elevation="2"
            size="x-large"
            bgColor="red"
        ...
        >
          ...
          >
            ...
            <p>Si es un error, por favor comuníquese al correo: <a href="mailto:support@javiervergara.com">support@javiervergara.com</a>.
            </p>
          </v-alert>
        </v-dialog>
      </div>
...
export default {
  ...
  components: {MText, ContactMeForm}
}
</script>
