...
def descargar():
    jsFile = open("Nombre de casi todos los iconos.js", 'w')

    for palabra in icons:
        palabraR = palabra
        # print(fichero.name)
        ...
        encontrado = re.search("-[a-z]", palabra, re.IGNORECASE)
        while encontrado:
            newWord = ""
            descompuesto = []
            ...
            ant = False
            for char in palabra:
                # descompuesto.append(palabraR[index])
            ...
            # print(descompuesto)
            # descompuesto[encontrado.span()[0]] = ""
            #
            # isNumber = False
            # for number in numbers:
            #     if descompuesto[encontrado.span()[0]+1] == number:
            #         isNumber = True
            #
            # if not isNumber:
            #     descompuesto[encontrado.span()[0] + 1] = descompuesto[encontrado.span()[0]+1].upper()
            #     pass
            #
            # print(encontrado.span()[0])
            #
            # print(encontrado)
            #
            # for descompuestoItem in descompuesto:
            #     newWord = newWord+descompuestoItem
            #
            # print(newWord)
            #
            # palabraR = newWord
            #
            # encontrado = re.search("-[a-z]", palabraR, re.IGNORECASE)

        jsFile.write(f'"{palabra}"?: string,\n')
