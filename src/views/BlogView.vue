...
v-app-bar(color="primary-container")
    ...
    template(v-slot:prepend)
        v-skeleton-loader(style={height: 'var(--ancho-barras)', "min-width": 'var(--ancho-barras)', "background-color": "transparent"} )
    ...
    v-skeleton-loader(type="img" style={height: 'var(--ancho-barras)', width: 'var(--ancho-barras)', "background-color": "transparent"} )
